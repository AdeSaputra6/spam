...
os.system("clear")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Sorry Minta Waktunya Sebentar Ya Bantu Klik Follow Instagram Artra ")
time.sleep(3)
os.system("xdg-open https://instagram.com/artra367?igshid=MzNlNGNkZWQ4Mg==")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Thx yang udah subscribe, semoga work Amin")
time.sleep(3)
os.system("clear")
autoketik(f"""
...
{abu}-----------------------------------------
{putih}[{biru}•{putih}] {biru}Author {putih}   : Saputra Store
{putih}[{biru}•{putih}] {abu}GitHub  {putih}   : PutraNewBie
{putih}[{biru}•{putih}] {merah}You   {putih}Tube {putih}  : Artra
{putih}[{biru}•{putih}] {ungu}Instagram {putih}: @artra367
